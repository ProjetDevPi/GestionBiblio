...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('DocumentBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DocumentBundle\Form\CategorieType', $categorie);
        ...
        return $this->render('@Document/categorie/new.html.twig', array(
            'categorie' => $categorie,
    ...
    public function showAction(Categorie $categorie)
    {
        ...
        return $this->render('@Document/categorie/show.html.twig', array(
            'categorie' => $categorie,
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('DocumentBundle\Form\CategorieType', $categorie);
        ...
        return $this->render('@Document/categorie/edit.html.twig', array(
            'categorie' => $categorie,
